...
from PyQt6.QtWidgets import QApplication, QDialog, QGridLayout, QLabel, \
    QMainWindow, QMessageBox, QTableWidget, QTableWidgetItem, QVBoxLayout, \
    QLineEdit, QComboBox, QPushButton, QToolBar, QStatusBar


class DatabaseConnection:
    def __init__(self, host="localhost", user="dan", password="password", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Sudent Management System")
        ...
        # Create status bar and add statusbar elements
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created for during the course "The Python Mega Course".
        Feel free to modify and reuse this code.
        """
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        number = main_window.table.item(index, 3).text()
